...
//            $model = Mage::getModel('catalog/entity_attribute');
            ...
            $ignore_source_models = array('', 'eav/entity_attribute_source_boolean', 'eav/entity_attribute_source_table' );
            if(in_array($model->getSourceModel(), $ignore_source_models)) {
                ...
                $data['source_model'] = $model->getSourceModel();
            }
